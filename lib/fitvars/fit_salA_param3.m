...
%LOAD FIELDS
field = {'tempA','salA','rhoA'};      f = 2; 
disp(['----- Field: ',num2str(field{f}), '-----'])

%load('../../io/sortN.mat','Nssal','Nsort_rad','pres')
load('../../io/sortI.mat','Issal','Isort_rad','pres')
  distance = Isort_rad;
       var = Issal;    
%load('../../io/sortO.mat','Ossal');
load('../../io/ref_pro.mat','autumn');
mPvar = autumn.msal; % nanmean(Ossal,2);
